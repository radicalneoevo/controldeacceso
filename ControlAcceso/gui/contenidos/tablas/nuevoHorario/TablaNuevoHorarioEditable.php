...
include_once("gui/contenidos/tablas/nuevoHorario/TablaNuevoHorario.php");
include_once("control/GestorAreas.php");
include_once("entidad/DiaSemana.php");

/**
 * Representa una tabla de nuevos horarios editable, con las acciones
 * correspondientes.
 *
...
class TablaNuevoHorarioEditable extends TablaNuevoHorario
{
    /**
    ...
    private function accionesFilaTablaHorario($horario)
    {
        ...
        $salida = $salida . '<input type="hidden" name="idNuevoHorario"  value="' . $horario->getIdNuevoHorario() . '" />';
        $salida = $salida . '<input type="submit" name="botonAceptarNuevoHorario" value="Aceptar" />&nbsp;';
        $salida = $salida . '<input type="submit" name="botonRechazarNuevoHorario" value="Rechazar" />';
        $salida = $salida . '</form>';
